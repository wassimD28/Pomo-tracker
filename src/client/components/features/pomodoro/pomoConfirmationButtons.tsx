...
function PomoConfirmationButtons() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "pointer-events-none absolute -top-0 grid w-80 select-none grid-cols-2 gap-4 opacity-0 transition-all duration-1000 ease-custom-ease 2xl:scale-150",
          pomoSession.isFocusComplete &&
            "pointer-events-auto top-40 opacity-100 2xl:top-60",
        )}
      >
        {/* take button */}
        <Button
