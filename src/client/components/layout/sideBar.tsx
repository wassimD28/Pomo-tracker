...
export const SideBar = () => {
  ...
  const [links, setLinks] = useState<LinkType[]>([
    ...
    { href: "/tasks", isActive: false, icon: ListCheck },
  ]);
  ...
  return (
    <div className="fixed z-50 flex h-full flex-col items-center justify-between px-4 py-4 text-custom-white-200 w-fit">
